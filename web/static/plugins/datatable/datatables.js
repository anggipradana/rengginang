 ...
 *   https://datatables.net/download/#bs4/dt-1.10.16/r-2.5.0
 *
 * Included libraries:
 *  DataTables 1.10.16, Responsive 2.5.0
 */
...
(function (h) {
  ...
  m.ext = x = {
    buttons: {},
    classes: {},
    builder: "bs4/dt-1.10.16/r-2.5.0",
    errMode: "alert",
    feature: [],
    search: [],
            ...
            modal: function (o) {
              return function (e, t, n, i) {
                ...
                return (
                  o &&
                    o.header &&
                    f("div.dtr-modal-content").prepend("<h2>" + o.header(e) + "</h2>"),
                  !0
                );
              };
            },
