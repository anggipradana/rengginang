...
from ReNgGinaNg.settings import LOGGING
...
def bulk_import_targets(
	...
	""" 
		Used to import targets in ReNgGinaNg
	...
	for target in targets:
		...
		if is_domain:
			...
			logger.warning(f'{name} is not supported by ReNgGinaNg')
			continue
...
def store_domain(domain_name, project, description, h1_team_handle):
	"""
		This function is used to store domain in ReNgGinaNg
	"""
